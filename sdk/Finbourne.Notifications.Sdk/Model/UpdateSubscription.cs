...
namespace Finbourne.Notifications.Sdk.Model
{
    ...
    public partial class UpdateSubscription : IEquatable<UpdateSubscription>, IValidatableObject
    {
        ...
        public UpdateSubscription(string displayName = default(string), string description = default(string), string status = default(string), MatchingPattern matchingPattern = default(MatchingPattern), string useAsAuth = default(string))
        {
            // to ensure "displayName" is required (not null)
            if (displayName == null)
            {
                throw new ArgumentNullException("displayName is a required property for UpdateSubscription and cannot be null");
            }
            this.DisplayName = displayName;
            // to ensure "status" is required (not null)
            if (status == null)
            {
                throw new ArgumentNullException("status is a required property for UpdateSubscription and cannot be null");
            }
            this.Status = status;
            // to ensure "matchingPattern" is required (not null)
            if (matchingPattern == null)
            {
                throw new ArgumentNullException("matchingPattern is a required property for UpdateSubscription and cannot be null");
            }
