...
namespace Finbourne.Notifications.Sdk.Model
{
    ...
    public partial class ResourceListOfAccessControlledResource : IEquatable<ResourceListOfAccessControlledResource>, IValidatableObject
    {
        /// <summary>
        ...
        public ResourceListOfAccessControlledResource(List<AccessControlledResource> values = default(List<AccessControlledResource>), string href = default(string), List<Link> links = default(List<Link>), string nextPage = default(string), string previousPage = default(string))
        {
            ...
            if (values == null)
            {
                throw new ArgumentNullException("values is a required property for ResourceListOfAccessControlledResource and cannot be null");
            }
            this.Values = values;
            this.Href = href;
            this.Links = links;
