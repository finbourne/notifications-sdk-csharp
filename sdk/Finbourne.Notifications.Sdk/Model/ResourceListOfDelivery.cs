...
namespace Finbourne.Notifications.Sdk.Model
{
    ...
    public partial class ResourceListOfDelivery : IEquatable<ResourceListOfDelivery>, IValidatableObject
    {
        /// <summary>
        ...
        public ResourceListOfDelivery(List<Delivery> values = default(List<Delivery>), string href = default(string), List<Link> links = default(List<Link>), string nextPage = default(string), string previousPage = default(string))
        {
            ...
            if (values == null)
            {
                throw new ArgumentNullException("values is a required property for ResourceListOfDelivery and cannot be null");
            }
            this.Values = values;
            this.Href = href;
            this.Links = links;
