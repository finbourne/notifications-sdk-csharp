...
namespace Finbourne.Notifications.Sdk.Model
{
    ...
    public partial class ResourceListOfNotification : IEquatable<ResourceListOfNotification>, IValidatableObject
    {
        /// <summary>
        ...
        public ResourceListOfNotification(List<Notification> values = default(List<Notification>), string href = default(string), List<Link> links = default(List<Link>), string nextPage = default(string), string previousPage = default(string))
        {
            ...
            if (values == null)
            {
                throw new ArgumentNullException("values is a required property for ResourceListOfNotification and cannot be null");
            }
            this.Values = values;
            this.Href = href;
            this.Links = links;
