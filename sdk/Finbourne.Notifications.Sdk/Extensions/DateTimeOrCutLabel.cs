...
namespace Finbourne.Notifications.Sdk
{
    /// <summary>
    ...
    public class DateTimeOrCutLabel
    {
        ...
        /// <returns></returns>
        public static implicit operator string(DateTimeOrCutLabel value)
        {
            return $"{value}";
        }
        ...
        /// </summary>
        /// <returns>an in indicating the length of the DateTimeOrCutLabel if it were converted to a string.</returns>
        public int Length
        {
