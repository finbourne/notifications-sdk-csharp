...
namespace Finbourne.Notifications.Sdk.Api
{
    ...
    public interface IManualEventApiSync : IApiAccessor
    {
        ...
        Finbourne.Notifications.Sdk.Client.ApiResponse<ManualEvent> TriggerManualEventWithHttpInfo(ManualEventRequest manualEventRequest, int operationIndex = 0, ConfigurationOptions? opts = null);
